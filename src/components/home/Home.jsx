...
import { BiHomeAlt, BiSearch, BiMessageRoundedCheck } from "react-icons/bi";
      ...
      <div className="App">
        ...
        <div className="header-container">
          ...
          {user && user.displayName && user.photoURL ? (
              // Display avatar with user's profile image and name
              ...
              // Display a placeholder avatar if user details are not available
              <div className="avatar-container-profile">
